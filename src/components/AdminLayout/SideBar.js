...
function SideBar({ toggle }) {
	return (
		<div className="flex flex-col h-full">
			...
			<nav>
				<ul className="ds-menu p-4 gap-3 border-t border-base-300">
					<li>
						<NavLink
							to="/dashboard"
			...
			<div className="mt-auto p-4 gap-3 flex flex-col md:flex-row lg:flex-col justify-between border-t border-base-300">
				<button className="ds-btn ds-btn-pastel ds-btn-block md:ds-btn-circle lg:ds-btn-block justify-between md:justify-center lg:justify-between lg:px-4 rounded-box lg:rounded-box">
					<span className="md:hidden lg:inline">
						<span className="opacity-50">Dark Mode: </span>Off
					</span>
					<span className="ds-swap ds-swap-rotate">
